...
<LI><A HREF="Input.jsp?method=10" TARGET="inputs"> getTestCalculate()</A></LI>
<LI><A HREF="Input.jsp?method=13" TARGET="inputs"> add(int,int)</A></LI>
<LI><A HREF="Input.jsp?method=20" TARGET="inputs"> subtract(int,int)</A></LI>
<LI><A HREF="Input.jsp?method=27" TARGET="inputs"> multiply(int,int)</A></LI>
</UL>
</BODY>
</HTML>